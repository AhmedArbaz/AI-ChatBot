...
// Making Google gemini API Setup
const API_KEY = "AIzaSyBvVJqVEijl2Jn-40Mt9FQxscTMdcGHwSM";
...
// ...class karnay say add kiay hain all Classes to the div
...
// Making function of Google APi 

const generateBotResponse = async (incomingMassegeDiv)=>{
    const messageElement = incomingMassegeDiv.querySelector(".message-text");
...
const handleOutgoingMessage = (e)=>{
    ...
    // clearing the textarea after thte message is sent
    messageInput.value = "";
    ...
    const outgoingMassegeDiv = createMessageElement(messageContent,"user-message");
...
// NOTE: jasay enter karin gay to vo cheez show ho jay 
